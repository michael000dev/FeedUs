...
val mobileVersionCode = 6
val mobileAppVersion = "0.4.0"
...
//        iosX64(),
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            implementation(libs.ai.model.hub.sdk)
        }
...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = System.getenv("SIGNING_KEY_STORE_PATH")?.let { rootProject.file(it) }
